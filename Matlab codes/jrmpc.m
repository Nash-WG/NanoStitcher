function [t,X,Q,a,pk,T] = jrmpc(V,X,varargin)
...
for i=1:2:numel(varargin)
    ...
    if ~isSetT && strcmpi(varargin{i},'t')
...
TV = cellfun(@(V,t) bsxfun(@plus,V,t),V,t,'uniformoutput',false);
...
for iter = 1:maxNumIter
    ...
    % solve for t
    t = cellfun(@(mW,mX,sumOfWeights) (mX-mW)/sumOfWeights,mW,mX,sumOfWeights,'uniformoutput',false);
